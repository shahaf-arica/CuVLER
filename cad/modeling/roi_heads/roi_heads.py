...
# Original code from https://github.com/facebookresearch/detectron2/blob/main/detectron2/modeling/roi_heads/roi_heads.py
# Modified by Shahaf Arica from https://github.com/facebookresearch/CutLER/blob/main/cutler/modeling/roi_heads/roi_heads.py
        ...
        **kwargs,
        ...
        Args:
            ...
            box_predictor (nn.Module): make box predictions from the feature.
                Should have the same interface as :class:`CustomStandardROIHeads`.
