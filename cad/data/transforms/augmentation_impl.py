...
class TransformationRecord:
    def __init__(self, scale_factor=None, rotation_angle=None, flip=None):
        self.scale_factor = scale_factor
        self.rotation_angle = rotation_angle
        self.flip = flip


class CustomAugmentation(Augmentation):
    def __init__(self, scale_factor=None, rotation_angle=None, flip=None):
        self.transformation_record = TransformationRecord(
            scale_factor=scale_factor,
            rotation_angle=rotation_angle,
            flip=flip
        )

    def get_transformation_record(self):
        return self.transformation_record

    def apply_transform(self, image, annotations):
        # Apply transformations to the image and annotations
        transformed_image = ...  # Apply transformations
        transformed_annotations = ...  # Apply transformations to annotations
