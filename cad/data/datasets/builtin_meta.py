...
# Original code from https://github.com/facebookresearch/detectron2/blob/main/detectron2/data/datasets/builtin_meta.py
# Code Modified by Shahaf Arica from https://github.com/facebookresearch/CutLER/blob/main/cutler/data/datasets/builtin_meta.py
...
def _get_builtin_metadata(dataset_name):
    ...
    elif dataset_name in ["imagenet", "cross_domain", "lvis", "voc", "coco_cls_agnostic", "openimages"]:
